...
Use the installed CSV workbench capability and deterministic checker. Do not weaken `.tuff-example/data-quality-policy.json` or disable the Stop hook. Report the final row count, total amount in GBP, corrections made, and report path.
